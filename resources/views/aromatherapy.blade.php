...
<head>
    ...
    <title>RynokBay-Aromatherapy</title>
                    ...
                    <div class="row g-lg-4 g-3">
                        ...
                        <div class="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                            <div class="single-product-card">
                                <div class="part-img">
                                    <a href="#"><img src="assets/images/aroma1.webp" alt="Product"></a>
                                ...
                                <div class="part-txt">
                                    <h4 class="product-name"><a href="#">Massage Aromatherapy

                                    </a></h4>
                                    <p class="dscr">Massage aromatherapy</p>
                        ...
                        <div class="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                            <div class="single-product-card">
                                <div class="part-img">
                                    <a href="#"><img src="assets/images/medical-aroma.webp" alt="Product"></a>
                                    <div class="cart-option cart-option-bottom">
                                        <ul>
                                            <li>
                                                <a role="button" class="add-to-cart">
                                ...
                                <div class="part-txt">
                                    <h4 class="product-name"><a href="#">Medical Aromatherapy

                                    </a></h4>
                                    <p class="dscr">Medical Aromatherapy</p>
                                    <p class="price"><span>$96.00</span>$75.00</p>
                                    <div class="star">
                                        <i class="fa-solid fa-star-sharp rated"></i>
                                        <i class="fa-solid fa-star-sharp rated"></i>
                        ...
                        <div class="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                            <div class="single-product-card">
                                <div class="part-img">
                                    <a href="#"><img src="assets/images/olfec.jpeg" alt="Product"></a>
                                    <div class="cart-option cart-option-bottom">
                                        <ul>
                                            <li>
                                                <a role="button" class="add-to-cart">
                                ...
                                <div class="part-txt">
                                    <h4 class="product-name"><a href="#">Olfactory Aromatherapy

                                    </a></h4>
                                    <p class="dscr">Aromatherapy</p>
                                    <p class="price"><span>$96.00</span>$75.00</p>
                                    <div class="star">
                                        <i class="fa-solid fa-star-sharp rated"></i>
                                        <i class="fa-solid fa-star-sharp rated"></i>
                        ...
                        <div class="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                            <div class="single-product-card">
                                <div class="part-img">
                                    <a href="#"><img src="assets/images/psycho.jpeg" alt="Product"></a>
                                    <div class="cart-option cart-option-bottom">
                                        <ul>
                                            <li>
                                                <a role="button" class="add-to-cart">
                                ...
                                <div class="part-txt">
                                    <h4 class="product-name"><a href="#">Psycho Aromatherapy
                        ...
                        <div class="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                            <div class="single-product-card">
                                <div class="part-img">
                                    <a href="#"><img src="assets/images/organic.jpeg" alt="Product"></a>
                                    <div class="cart-option cart-option-bottom">
                                        <ul>
                                            <li>
                                                <a role="button" class="add-to-cart">
                                ...
                                <div class="part-txt">
                                    <h4 class="product-name"><a href="#">Organic Aromatherapy
                        ...
                        <div class="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                            <div class="single-product-card">
                                <div class="part-img">
                                    <a href="#"><img src="assets/images/casual.jpeg" alt="Product"></a>
                                    <div class="cart-option cart-option-bottom">
                                        <ul>
                                            <li>
                                                <a role="button" class="add-to-cart">
                                ...
                                <div class="part-txt">
                                    <h4 class="product-name"><a href="#">Casual Aromatherapy
