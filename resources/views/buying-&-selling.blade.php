...
<head>
    ...
    <title>RynokBay - Buying & Selling</title>

    <link rel="icon" type="image/x-icon" href="assets/images/favicon.png">    <link rel="stylesheet" href="assets/vendor/css/all.min.css">
                    ...
                    <div class="row g-lg-4 g-3">
                          <div class="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                            <div class="single-product-card">
                                <div class="part-img">
                                    ...
                                    <a href="#"><img src="assets/images/p1.jpeg" alt="Product" style="height: 182px;"></a>
                                ...
                                <div class="part-txt">
                                    <h4 class="product-name"><a href="#">Looking For Garden House</a></h4>
                                    <p class="dscr">Looking For House With Garden</p>
                        ...
                        <div class="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                            <div class="single-product-card">
                                <div class="part-img">
                                    <!-- <span class="off-tag">15%</span> -->
                                    <a href="#"><img src="assets/images/p2.jpeg" alt="Product" style="height: 182px;"></a>
                                ...
                                <div class="part-txt">
                                    <h4 class="product-name"><a href="#">Looking For House</a></h4>
                                    <p class="dscr">Looking For House</p>
                                    <p class="price"><span>$96.00</span>$75.00</p>
                                    <div class="star">
                                        <i class="fa-solid fa-star-sharp rated"></i>
                                        <i class="fa-solid fa-star-sharp rated"></i>
                        ...
                        <div class="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                            <div class="single-product-card">
                                <div class="part-img">
                                    <!-- <span class="off-tag">15%</span> -->
                                    <a href="#"><img src="assets/images/p3.jpeg" alt="Product" style="height: 182px;"></a>
                                ...
                                <div class="part-txt">
                                    <h4 class="product-name"><a href="#">Looking For Villa</a></h4>
                                    <p class="dscr">Looking For Villa</p>
                                    <p class="price"><span>$96.00</span>$75.00</p>
                                    <div class="star">
                                        <i class="fa-solid fa-star-sharp rated"></i>
                                        <i class="fa-solid fa-star-sharp rated"></i>
                        ...
                        <div class="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                            <div class="single-product-card">
                                <div class="part-img">
                                    <!-- <span class="off-tag">15%</span> -->
                                    <a href="#"><img src="assets/images/p4.jpeg" alt="Product" style="height: 182px;"></a>
                                ...
                                <div class="part-txt">
                                    <h4 class="product-name"><a href="#">Garden For Sale</a></h4>
                                    <p class="dscr">Garden For Sale</p>
                                    <p class="price"><span>$96.00</span>$75.00</p>
                                    <div class="star">
                                        <i class="fa-solid fa-star-sharp rated"></i>
                                        <i class="fa-solid fa-star-sharp rated"></i>
                        ...
                        <div class="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                            <div class="single-product-card">
                                <div class="part-img">
                                    <!-- <span class="off-tag">15%</span> -->
                                    <a href="#"><img src="assets/images/p5.jpeg" alt="Product" style="height: 182px;"></a>
                                ...
                                <div class="part-txt">
                                    <h4 class="product-name"><a href="#">Villa For Sale </a></h4>
                                    <p class="dscr">Villa For Sale</p>
                                    <p class="price"><span>$96.00</span>$75.00</p>
                                    <div class="star">
                                        <i class="fa-solid fa-star-sharp rated"></i>
                                        <i class="fa-solid fa-star-sharp rated"></i>
                        ...
                        <div class="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                            <div class="single-product-card">
                                <div class="part-img">
                                    <!-- <span class="off-tag">15%</span> -->
                                    <a href="#"><img src="assets/images/p6.jpeg" alt="Product" style="height: 182px;"></a>
                                ...
                                <div class="part-txt">
                                    <h4 class="product-name"><a href="#">House For Sale</a></h4>
                                    <p class="dscr">House For Sale</p>
                                    <p class="price"><span>$96.00</span>$75.00</p>
                                    <div class="star">
                                        <i class="fa-solid fa-star-sharp rated"></i>
                                        <i class="fa-solid fa-star-sharp rated"></i>
