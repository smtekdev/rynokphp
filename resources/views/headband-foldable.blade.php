...
<head>
    ...
    <title>RynokBay - Single Product Page</title>
                                ...
                                <div class="row">
                                    <div class="col-xl-6 col-lg-5 col-md-6">
                                        <div class="part-img mr-30">
                                            <div class="img-box" id="bigPreview">
                                                <img src="assets/images/shop-details-img-1.jpg" alt="Image" style="max-width: 100%;">
                                    ...
                                    <div class="col-xl-6 col-lg-7 col-md-6">
                                        <div class="part-txt">
                                            ...
                                            <p class="dscr">P47 Headband Foldable Stereo Bluetooth Headphones Wireless Headset Noise Cancelling Casque Audio Handsfree headphone</p>
                                            <form>
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="nav-dscr" role="tabpanel" aria-labelledby="nav-dscr-tab" tabindex="0">
                                        <div class="product-dscr">
                                            <p style="margin-bottom: 14px;">This headphone offers you a sleek style with a slim profile but also an adjustable contoured headband, It allows you to get a great position on your head. The headphones are extra comfortable so that your ears don't hurt after wearing them for a long time. This foldable portable design makes it easy to take along on that next vacation or business trip or to store in your desk drawer for use at work. So,What are you waiting for? 
            
                                                The Multifunctional headphone combines the Bluetooth, Card MP3 player and FM Radio function, and supports hands-free function. With this product, you greatly enjoy the wonderful wireless music, listen to FM radio, and it also can be worked as a MP3 Player because it supports Memory card (MicroSD / TF card). Moreover, don't worry, if your music players (Such as, MP3 / MP4, etc) have no Bluetooth function, you can connect the music players to the headset via the included 3.5mm audio cable to enjoy your favorite music. 3.5mm audio jack, provides a simple wired connection of a variety of music players (Such as, MP3 / MP4, etc) without Bluetooth function.Easy to pair with almost any Bluetooth-enabled audio / music players devices, such as, Smart Phones, Tablet PC, Laptop, NoteBook, etc. Best designed with two High-grade speaker and has built-in Mic,, powerful bass system, bring you superior sound effect. Best choice for listening to music / FM Radio, watching movie, chatting online, etc. Supports hands-free function, conveniently answer the incoming call during travel, work, driving, exercising, lifting etc. P47 offers the best experience ever. Buy this P47 Foldable Wireless Bluetooth Headphones on steaman at the best price.     SPECIFICATIONS High Quality Adjustable Headband  Foldable Portable Design Easy to controls your headphones Works with or without Bluetooth capability  Type: Stereo headphone with Mic Bluetooth version: 4.1 Plug Type: 3.5mm Color:Grey/Red Support:Bluetooth, Aux in, TF Card, FM radio Operation Distance: 10m;   CONTENT: headphone 3.5mm stereo cable charging cable  </p>
