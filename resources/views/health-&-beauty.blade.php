                    ...
                    <div class="row g-lg-4 g-3">
                        <div class="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                            <div class="single-product-card">
                                <div class="part-img">
                                    <a href="#"><img src="assets/images/548576_1.webp" alt="Product" style="height: 250px;"></a>
                                ...
                                <div class="part-txt">
                                    <h4 class="product-name"><a href="#">Maybelline NY Instant Age</a></h4>
                                    <p class="dscr">Here</p>
                        ...
                        <div class="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                            <div class="single-product-card">
                                <div class="part-img">
                                    ...
                                    <a href="#"><img src="assets/images/SkinCeuticals-Soothing-Cleanser-Cleansing-Foam-5oz-3606000463660.jpg" alt="Product" style="height: 250px;"></a>
                                ...
                                <div class="part-txt">
                                    <h4 class="product-name"><a href="#">Soothing Cleansing Foam</a></h4>
                                    <p class="dscr">Here</p>
                                    <p class="price"><span>$96.00</span>$75.00</p>
                                    <div class="star">
                                        <i class="fa-solid fa-star-sharp rated"></i>
                        ...
                        <div class="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                            <div class="single-product-card">
                                <div class="part-img">
                                    <a href="#"><img src="assets/images/Intensegrowth.webp" alt="Product" style="height: 250px;"></a>
                                    <div class="cart-option cart-option-bottom">
                                        <ul>
                                            <li>
                                                <a role="button" class="add-to-cart">
                                ...
                                <div class="part-txt">
                                    <h4 class="product-name"><a href="#">Intense Hair Oil</a></h4>
                                    <p class="dscr">Here</p>
                                    <p class="price"><span>$96.00</span>$75.00</p>
                                    <div class="star">
                                        <i class="fa-solid fa-star-sharp rated"></i>
                        ...
                        <div class="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                            <div class="single-product-card">
                                <div class="part-img">
                                    <!-- <span class="off-tag">15%</span> -->
                                    <a href="#"><img src="assets/images/546030_1.webp" alt="Product" style="height: 250px;"></a>
                                    <div class="cart-option cart-option-bottom">
                                        <ul>
                                            <li>
                                                <a role="button" class="add-to-cart">
                        ...
                        <div class="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                            <div class="single-product-card">
                                <div class="part-img">
                                    <a href="#"><img src="assets/images/120mlAppricot.webp" alt="Product" style="height: 250px;"></a>
                                    <div class="cart-option cart-option-bottom">
                                        <ul>
                                            <li>
                                                <a role="button" class="add-to-cart">
                                ...
                                <div class="part-txt">
                                    <h4 class="product-name"><a href="#">Organic Sweet Apricot Oil
                                    </a></h4>
                                    <p class="dscr">Here</p>
                                    <p class="price"><span>$96.00</span>$75.00</p>
                                    <div class="star">
                        ...
                        <div class="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                            <div class="single-product-card">
                                <div class="part-img">
                                    <a href="#"><img src="assets/images/536474_1.jpg" alt="Product" style="height: 250px;"></a>
                                    <div class="cart-option cart-option-bottom">
                                        <ul>
                                            <li>
                                                <a role="button" class="add-to-cart">
