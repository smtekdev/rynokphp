                    ...
                    <div class="row g-lg-4 g-3">
                        <div class="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                            <div class="single-product-card">
                                <div class="part-img">
                                    <a href="#"><img src="assets/images/am1.jpeg" alt="Product" style="height: 250px;"></a>
                                ...
                                <div class="part-txt">
                                    <h4 class="product-name"><a href="#">Car Headlight</a></h4>
                                    <p class="dscr">Car Headlight</p>
                        ...
                        <div class="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                            <div class="single-product-card">
                                <div class="part-img">
                                    <a href="#"><img src="assets/images/am2.jpeg" alt="Product" style="height: 250px;"></a>
                                    <div class="cart-option cart-option-bottom">
                                        <ul>
                                            <li>
                                                <a role="button" class="add-to-cart">
                                ...
                                <div class="part-txt">
                                    <h4 class="product-name"><a href="#">Car Bumper</a></h4>
                                    <p class="dscr">Car Bumper</p>
                                    <p class="price"><span>$96.00</span>$75.00</p>
                                    <div class="star">
                                        <i class="fa-solid fa-star-sharp rated"></i>
                                        <i class="fa-solid fa-star-sharp rated"></i>
                        ...
                        <div class="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                            <div class="single-product-card">
                                <div class="part-img">
                                    <a href="#"><img src="assets/images/am3.jpeg" alt="Product" style="height: 250px;"></a>
                                    <div class="cart-option cart-option-bottom">
                                        <ul>
                                            <li>
                                                <a role="button" class="add-to-cart">
                                ...
                                <div class="part-txt">
                                    <h4 class="product-name"><a href="#">Car Key Remote</a></h4>
                                    <p class="dscr">Car Key Remote</p>
                                    <p class="price"><span>$96.00</span>$75.00</p>
                                    <div class="star">
                                        <i class="fa-solid fa-star-sharp rated"></i>
                                        <i class="fa-solid fa-star-sharp rated"></i>
                        ...
                        <div class="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                            <div class="single-product-card">
                                <div class="part-img">
                                    <a href="#"><img src="assets/images/am4.jpeg" alt="Product" style="height: 250px;"></a>
                                    <div class="cart-option cart-option-bottom">
                                        <ul>
                                            <li>
                                                <a role="button" class="add-to-cart">
                                ...
                                <div class="part-txt">
                                    <h4 class="product-name"><a href="#">Hybrids Batteries</a></h4>
                                    <p class="dscr">Hybrids Batteries</p>
                                    <p class="price"><span>$96.00</span>$75.00</p>
                                    <div class="star">
                                        <i class="fa-solid fa-star-sharp rated"></i>
                                        <i class="fa-solid fa-star-sharp rated"></i>
                        ...
                        <div class="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                            <div class="single-product-card">
                                <div class="part-img">
                                    <a href="#"><img src="assets/images/am5.jpeg" alt="Product" style="height: 250px;"></a>
                                    <div class="cart-option cart-option-bottom">
                                        <ul>
                                            <li>
                                                <a role="button" class="add-to-cart">
                                ...
                                <div class="part-txt">
                                    <h4 class="product-name"><a href="#">Truck Backlight</a></h4>
                                    <p class="dscr">Truck Backlight</p>
                                    <p class="price"><span>$96.00</span>$75.00</p>
                                    <div class="star">
                                        <i class="fa-solid fa-star-sharp rated"></i>
                                        <i class="fa-solid fa-star-sharp rated"></i>
                        ...
                        <div class="product-col col-xxl-3 col-xl-4 col-lg-6 col-md-4 col-6">
                            <div class="single-product-card">
                                <div class="part-img">
                                    <a href="#"><img src="assets/images/am6.jpeg" alt="Product" style="height: 250px;"></a>
                                    <div class="cart-option cart-option-bottom">
                                        <ul>
                                            <li>
                                                <a role="button" class="add-to-cart">
                                ...
                                <div class="part-txt">
                                    <h4 class="product-name"><a href="#">Car Multimedia</a></h4>
                                    <p class="dscr">Car Multimedia</p>
                                    <p class="price"><span>$96.00</span>$75.00</p>
                                    <div class="star">
                                        <i class="fa-solid fa-star-sharp rated"></i>
                                        <i class="fa-solid fa-star-sharp rated"></i>
